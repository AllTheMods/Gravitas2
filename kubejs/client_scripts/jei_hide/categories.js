...
let hideCats = (event) => {
   ...
   event.remove(recipeCategories.railcraft_crusher)

   event.remove(recipeCategories.enderio_sagmilling)
   event.remove(recipeCategories.enderio_alloy_smelting)
   event.remove(recipeCategories.enderio_primitive_alloy_smelting)

   event.remove(recipeCategories.jumbofurnace_jumbo_smelting)
