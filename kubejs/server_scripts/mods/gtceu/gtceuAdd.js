...
let gtceuAdd = (/** @type {Internal.RecipesEventJS} */ event) => {
    ...
    event.recipes.kubejs.shaped('2x gtceu:pump_deck', ['   ', 'SPS', 'sCh'], { S: 'gtceu:wrought_iron_screw', P: '#forge:treated_wood', C: '#forge:slabs/cobblestone', s: '#forge:tools/screwdrivers', h: '#forge:tools/hammers' }).damageIngredient(['#forge:tools'])
    event.recipes.kubejs.shaped('gtceu:pump_hatch', ['SRs', 'PLP', 'CRC'], { S: 'gtceu:wrought_iron_screw', P: '#forge:treated_wood', C: '#forge:slabs/cobblestone', R: 'gtceu:wrought_iron_ring', L: 'gtceu:wood_large_fluid_pipe', s: '#forge:tools/screwdrivers' }).damageIngredient(['#forge:tools'])
    event.recipes.kubejs.shaped('gtceu:primitive_pump', ['RNS', 'BPs', 'CLC'], { S: 'gtceu:wrought_iron_screw', P: '#forge:treated_wood', C: '#forge:slabs/cobblestone', R: 'gtceu:wrought_iron_ring', L: 'gtceu:wood_large_fluid_pipe', N: 'gtceu:wood_normal_fluid_pipe', B: 'gtceu:wrought_iron_rotor', s: '#forge:tools/screwdrivers' }).damageIngredient(['#forge:tools'])
   ...
   event.recipes.gtceu.alloy_smelter('alabaster_brick_with_dust')
    ...
    //wireless chargers
        ...
        //I&F stuff
        event.recipes.gtceu.macerator('gregitas:crushed_crackle_material')
        .itemInputs(
            '1x #iceandfire:crackled_blocks'
        )
        .itemOutputs('gregitas:crushed_crackle_material')
        .duration(100)
        .EUt(HV)

        event.recipes.gtceu.macerator('gregitas:crushed_charred_material')
        .itemInputs(
            '1x #iceandfire:charred_blocks'
        )
        .itemOutputs('gregitas:crushed_charred_material')
        .duration(100)
        .EUt(HV)

        event.recipes.gtceu.macerator('gregitas:crushed_frostburn_material')
        .itemInputs(
            '1x #iceandfire:frozen_blocks'
        )
