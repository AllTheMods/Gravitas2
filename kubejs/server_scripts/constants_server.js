...
global.gtOreMaterials = [
  { mod: "gtceu", material: "chalcocite" },
  { mod: "minecraft", material: "emerald" },
  { mod: "gtceu", material: "aluminium" },
  { mod: "minecraft", material: "redstone", result: "minecraft:redstone" },
  { mod: "gtceu", material: "magnetite" },
  { mod: "gtceu", material: "olivine" },
  { mod: "gtceu", material: "oilsands" },
  { mod: "gtceu", material: "opal" },
  { mod: "gtceu", material: "diatomite" },
  { mod: "minecraft", material: "coal" },
  { mod: "gtceu", material: "monazite" },
  { mod: "gtceu", material: "titanium" },
  { mod: "gtceu", material: "tungstate" },
  { mod: "gtceu", material: "blue_topaz" },
  { mod: "gtceu", material: "garnierite" },
  { mod: "gtceu", material: "vanadium_magnetite" },
  { mod: "gtceu", material: "uraninite" },
  { mod: "gtceu", material: "silver" },
  { mod: "gtceu", material: "grossular" },
  { mod: "gtceu", material: "sapphire" },
  { mod: "gtceu", material: "lazurite" },
  { mod: "gtceu", material: "cinnabar" },
  { mod: "gtceu", material: "iron" },
  { mod: "gtceu", material: "hematite" },
  { mod: "gtceu", material: "molybdenum" },
  { mod: "gtceu", material: "glauconite_sand" },
  { mod: "gtceu", material: "beryllium" },
  { mod: "gtceu", material: "neodymium" },
  { mod: "gtceu", material: "cobalt" },
  { mod: "gtceu", material: "tetrahedrite" },
  { mod: "gtceu", material: "green_sapphire" },
  { mod: "gtceu", material: "gold" },
  { mod: "gtceu", material: "chromite" },
  { mod: "gtceu", material: "apatite" },
  { mod: "gtceu", material: "sphalerite" },
  { mod: "gtceu", material: "tin" },
  { mod: "gtceu", material: "saltpeter" },
  { mod: "gtceu", material: "salt" },
  { mod: "gtceu", material: "yellow_limonite" },
  { mod: "gtceu", material: "calcite" },
  { mod: "gtceu", material: "spessartine" },
  { mod: "gtceu", material: "cassiterite" },
  { mod: "gtceu", material: "mica" },
  { mod: "gtceu", material: "palladium" },
  { mod: "gtceu", material: "pyrite" },
  { mod: "gtceu", material: "sodalite" },
  { mod: "gtceu", material: "lepidolite" },
  { mod: "gtceu", material: "quartzite" },
  { mod: "gtceu", material: "fullers_earth" },
  { mod: "gtceu", material: "yellow_garnet" },
  { mod: "gtceu", material: "molybdenite" },
  { mod: "gtceu", material: "zeolite" },
  { mod: "gtceu", material: "bentonite" },
  { mod: "gtceu", material: "spodumene" },
  { mod: "gtceu", material: "pyrolusite" },
  { mod: "gtceu", material: "platinum" },
  { mod: "gtceu", material: "talc" },
  { mod: "gtceu", material: "bauxite" },
  { mod: "gtceu", material: "copper" },
  { mod: "gtceu", material: "topaz" },
  { mod: "gtceu", material: "ruby" },
  { mod: "gtceu", material: "plutonium" },
  { mod: "gtceu", material: "amethyst" },
  { mod: "gtceu", material: "electrotine" },
  { mod: "gtceu", material: "malachite" },
  { mod: "gtceu", material: "lithium" },
  { mod: "gtceu", material: "sulfur" },
  { mod: "gtceu", material: "garnet_sand" },
  { mod: "gtceu", material: "tantalite" },
  { mod: "gtceu", material: "goethite" },
  { mod: "gtceu", material: "asbestos" },
  { mod: "gtceu", material: "scheelite" },
  { mod: "gtceu", material: "pentlandite" },
  { mod: "gtceu", material: "wulfenite" },
  { mod: "gtceu", material: "pollucite" },
  { mod: "gtceu", material: "granitic_mineral_sand" },
  { mod: "gtceu", material: "tricalcium_phosphate" },
  { mod: "gtceu", material: "cobaltite" },
  { mod: "gtceu", material: "rock_salt" },
  { mod: "gtceu", material: "soapstone" },
  { mod: "minecraft", material: "lapis" },
  { mod: "gtceu", material: "pyrochlore" },
  { mod: "gtceu", material: "magnesite" },
  { mod: "gtceu", material: "certus_quartz" },
  { mod: "gtceu", material: "nickel" },
  { mod: "gtceu", material: "powellite" },
  { mod: "gtceu", material: "alunite" },
  { mod: "gtceu", material: "basaltic_mineral_sand" },
  { mod: "gtceu", material: "cooperite" },
  { mod: "gtceu", material: "realgar" },
  { mod: "gtceu", material: "graphite" },
  { mod: "gtceu", material: "barite" },
  { mod: "gtceu", material: "gypsum" },
  { mod: "gtceu", material: "galena" },
  { mod: "gtceu", material: "kyanite" },
  { mod: "minecraft", material: "diamond" },
  { mod: "gtceu", material: "naquadah" },
  { mod: "gtceu", material: "trona" },
  { mod: "gtceu", material: "bornite" },
  { mod: "gtceu", material: "stibnite" },
  { mod: "gtceu", material: "bastnasite" },
  { mod: "gtceu", material: "thorium" },
  { mod: "gtceu", material: "red_garnet" },
  { mod: "gtceu", material: "almandine" },
  { mod: "gtceu", material: "chalcopyrite" },
  { mod: "gtceu", material: "pitchblende" },
  { mod: "minecraft", material: "nether_quartz" },
  { mod: "gtceu", material: "pyrope" },
  { mod: "gtceu", material: "ilmenite" },
  { mod: "gtceu", material: "cassiterite_sand" },
  { mod: "gtceu", material: "lead" },
  { mod: "gcyr", material: "fluorite" },
]
