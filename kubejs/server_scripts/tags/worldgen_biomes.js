...
const removeBiomesFromStructures = (/** @type {TagEvent.Biome} */ event) => {
  ...
  event.get("repurposed:structures:has_structure/strongholds/nether").removeAll()
}
...
const addBiomesToStructures = (/** @type {TagEvent.Biome} */ event) => {
  ...
  event.get("ad_astra:has_structure/meteor_biomes").removeAll()
  event.add("ad_astra:has_structure/meteor_biomes", ["ad_astra:lunar_wastelands"])
}
