...
let tfcGregTools = (/** @type {Internal.RecipesEventJS} */ event) => {
  ...
  gtceuToolsTFC.forEach((metal) => {
    ...
    event.shaped(`gtceu:${metal.id}_wrench`, ["Ls", "SB"], {
  ...
  gtceuToolsGT.forEach((metal) => {
    ...
    event
      ...
      .id(`gregitas:shpaed/${metal.id}_sword`)
  })
  ...
  gtceuToolsGT.forEach((metal) => {
    ...
    event
      ...
      .id(`gregitas:shpaed/${metal.id}_pickaxe`)
  })
  ...
  gtceuToolsGT.forEach((metal) => {
    ...
    event
      ...
      .id(`gregitas:shpaed/${metal.id}_axe`)
  })
  ...
  gtceuToolsGT.forEach((metal) => {
    ...
    event
      ...
      .id(`gregitas:shpaed/${metal.id}_shovel`)
  })
  ...
  gtceuToolsGT.forEach((metal) => {
    ...
    event
      ...
      .id(`gregitas:shpaed/${metal.id}_hoe`)
  })
  ...
  gtceuToolsGT.forEach((metal) => {
    ...
    event
      ...
      .id(`gregitas:shpaed/${metal.id}_scythe`)
  })
