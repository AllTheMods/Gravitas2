...
let tfcGregTools = (/** @type {Internal.RecipesEventJS} */ event) => {
    ...
    GTRegistries.MATERIALS.forEach(material => {
        event.remove(`gtceu:shaped/file_${material.name}`)
        event.remove(`gtceu:shaped/wrench_${material.name}`)
        event.remove(`gtceu:shaped/saw_${material.name}`)
        event.remove(`gtceu:shaped/plunger_${material.name}`)
        event.remove(`gtceu:shaped/hammer_${material.name}`)
        event.remove(`gtceu:shaped/knife_${material.name}`)
        event.remove(`gtceu:shaped/screwdriver_${material.name}`)
        event.remove(`gtceu:shaped/crowbar_${material.name}`)
        event.remove(`gtceu:shaped/mortar_${material.name}`)
        event.remove(`gtceu:shaped/soft_mallet_${material.name}`)
        event.remove(`gtceu:shaped/wire_cutter_${material.name}`)
        event.remove(`gtceu:shaped/sword_${material.name}`)
        event.remove(`gtceu:shaped/pickaxe_${material.name}`)
        event.remove(`gtceu:shaped/axe_${material.name}`)
        event.remove(`gtceu:shaped/shovel_${material.name}`)
        event.remove(`gtceu:shaped/hoe_${material.name}`)
        event.remove(`gtceu:shaped/scythe_${material.name}`)
        event.remove(`gtceu:shaped/butchery_knife_${material.name}`)
        event.remove(`gtceu:shaped/plate_${material.name}`)
        event.remove(`gtceu:shaped/double_${material.name}_plate`)
        event.remove(`gtceu:shaped/stick_${material.name}`)
        event.remove(`gtceu:shaped/stick_long_${material.name}`)
        event.remove(`gtceu:shaped/stick_long_stick_${material.name}`)
    })
