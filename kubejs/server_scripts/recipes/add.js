...
const recipeAdd = (/** @type {Internal.RecipesEventJS} */ event) => {
  const { crafting_shaped: shaped, crafting_shapeless: shapeless } = event.recipes.minecraft
  ...
  shaped('gtceu:wrought_iron_wire_cutter', [' F ', 'HCD', 'RSR'], {
    F: '#forge:tools/files',
