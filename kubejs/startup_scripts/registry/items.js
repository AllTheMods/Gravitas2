...
let registerItems = (/** @type {Registry.Item} */ event) => {
  ...
  //Circuits
    ...
    event.create('gregitas:bioware_processor_assembly').texture('kubejs:item/circuits/bioware_processor_assembly').tag("forge:circuits/uev")
    event.create('gregitas:bioware_processor_computer').texture('kubejs:item/circuits/bioware_processor_computer').tag("forge:circuits/uiv")
    event.create('gregitas:bioware_processor_mainframe').texture('kubejs:item/circuits/bioware_processor_mainframe').tag("forge:circuits/uxv")
    event.create('gregitas:sculkware_processor').texture('kubejs:item/circuits/optical_processor').tag("forge:circuits/uev")
    event.create('gregitas:sculkware_processor_assembly').texture('kubejs:item/circuits/optical_processor_assembly').tag("forge:circuits/uiv")
    event.create('gregitas:sculkware_processor_computer').texture('kubejs:item/circuits/optical_processor_computer').tag("forge:circuits/uxv")
    event.create('gregitas:sculkware_processor_mainframe').texture('kubejs:item/circuits/optical_processor_mainframe').tag("forge:circuits/opv")
    event.create('gregitas:cosmic_processor').texture('kubejs:item/circuits/optical_processor').tag("forge:circuits/uiv")
    event.create('gregitas:cosmic_processor_assembly').texture('kubejs:item/circuits/optical_processor_assembly').tag("forge:circuits/uxv")
    event.create('gregitas:cosmic_processor_computer').texture('kubejs:item/circuits/optical_processor_computer').tag("forge:circuits/opv")
    event.create('gregitas:cosmic_processor_mainframe').texture('kubejs:item/circuits/optical_processor_mainframe').tag("forge:circuits/max")
